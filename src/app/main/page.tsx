...
export default function MainPage() {
  ...
  return (
    <div className="relative min-h-[852px] w-full max-w-[375px] mx-auto">
      <Background
      ...
      {/* 로그인 링크 */}
      <div className="fixed text-center bottom-[108px] left-1/2 transform -translate-x-1/2 w-[315px] max-w-[315px] flex justify-center gap-2">
      ...
      {/* 카카오 로그인 버튼 */}
      <div className="fixed bottom-[42px] left-1/2 transform -translate-x-1/2 w-[315px] max-w-[315px]">

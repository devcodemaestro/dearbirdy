...
export default function MyBuddyIntro() {
  return (
    <div className="relative flex flex-col items-center text-black bg-[#292D32] max-h-[852px]">
      {/* 🐦 사용자 프로필 섹션 */}
      <ProfileSection />

      <div className="w-[375px] bg-[#F9F8F3] h-[305px] rounded-t-[20px] px-[16px] pt-[32px] pb-[24px] mt-[25px] flex flex-col gap-[24px]">
        {/* 📩 편지 기록 */}
        <LetterHistory />

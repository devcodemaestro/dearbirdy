...
interface BuddyResultActionsProps {
  birdData: { birdName: string } | null;
}

const BuddyResultActions = ({ birdData }: BuddyResultActionsProps) => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      sessionStorage.removeItem("buddytest-storage");
...
export default BuddyResultActions;
